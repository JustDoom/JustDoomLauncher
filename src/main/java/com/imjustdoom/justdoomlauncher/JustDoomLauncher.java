package com.imjustdoom.justdoomlauncher;

import com.imjustdoom.justdoomlauncher.application.LauncherApplication;
...
public class JustDoomLauncher {
    ...
    private static JustDoomLauncher INSTANCE;

    public JustDoomLauncher(String[] args) {
        INSTANCE = this;

        Application.launch(LauncherApplication.class, args);
    }

    public static JustDoomLauncher get() {
        return INSTANCE;
    }
...
//    private final ProjectFiles files = new ProjectFiles(Path.of(new File(JustDoomLauncher.class.getProtectionDomain().getCodeSource().getLocation().toURI()).toURI()));
//
